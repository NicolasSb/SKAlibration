...
/**
*	@brief creates an initialized complex
*	@param re the real part of the complex
*	@param im the imaginary part of the compllex
*/
...
{
    //if(a.re >=128 || a.im >=128 || a.re <=128 || a.im <=128)
